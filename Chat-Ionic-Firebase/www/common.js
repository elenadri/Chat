...
/* harmony import */ var _angular_fire_firestore_firestore__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! @angular/fire/firestore/firestore */ "./node_modules/@angular/fire/firestore/firestore.js");
...
var AuthService = /** @class */ (function () {
    ...
    AuthService.prototype.iniciarSesion = function (email, password) {
        var _this = this;
    ...
    AuthService.prototype.registrarUsuario = function (name, email, password) {
        var _this = this;
        return new Promise(function (resolve, reject) {
            _this.AFauth.auth.createUserWithEmailAndPassword(email, password).then(function (res) {
                ...
                _this.db.collection('Usuarios').doc(res.user.uid).set({
                    userid: uid,
                    name: name,
                    email: email,
                });
    ...
    AuthService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_2__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_3__["Router"],
            _angular_fire_firestore_firestore__WEBPACK_IMPORTED_MODULE_4__["AngularFirestore"]])
    ], AuthService);
    return AuthService;
}());

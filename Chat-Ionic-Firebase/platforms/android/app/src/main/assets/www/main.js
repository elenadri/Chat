...
var map = {
	"./componentes/chat-add/chat-add.module": [
...
var routes = [
    ...
    { path: 'login', loadChildren: './componentes/login/login.module#LoginPageModule', canActivate: [_guards_nologin_guard__WEBPACK_IMPORTED_MODULE_4__["NologinGuard"]] },
    { path: 'registro', loadChildren: './componentes/registro/registro.module#RegistroPageModule', canActivate: [_guards_nologin_guard__WEBPACK_IMPORTED_MODULE_4__["NologinGuard"]] },
...
/* harmony import */ var _componentes_chat_chat_component__WEBPACK_IMPORTED_MODULE_13__ = __webpack_require__(/*! ./componentes/chat/chat.component */ "./src/app/componentes/chat/chat.component.ts");
/* harmony import */ var _angular_forms__WEBPACK_IMPORTED_MODULE_14__ = __webpack_require__(/*! @angular/forms */ "./node_modules/@angular/forms/fesm5/forms.js");
/* harmony import */ var _ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_15__ = __webpack_require__(/*! @ionic-native/sms/ngx */ "./node_modules/@ionic-native/sms/ngx/index.js");
...
var AppModule = /** @class */ (function () {
    ...
    AppModule = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["NgModule"])({
            declarations: [_app_component__WEBPACK_IMPORTED_MODULE_7__["AppComponent"], _componentes_chat_chat_component__WEBPACK_IMPORTED_MODULE_13__["ChatComponent"]],
            entryComponents: [_componentes_chat_chat_component__WEBPACK_IMPORTED_MODULE_13__["ChatComponent"]],
            imports: [_angular_platform_browser__WEBPACK_IMPORTED_MODULE_2__["BrowserModule"], _ionic_angular__WEBPACK_IMPORTED_MODULE_4__["IonicModule"].forRoot(), _app_routing_module__WEBPACK_IMPORTED_MODULE_8__["AppRoutingModule"],
                ...
                _angular_fire_auth__WEBPACK_IMPORTED_MODULE_11__["AngularFireAuthModule"], _angular_fire_firestore__WEBPACK_IMPORTED_MODULE_12__["AngularFirestoreModule"], _angular_forms__WEBPACK_IMPORTED_MODULE_14__["FormsModule"]],
            providers: [_ionic_native_sms_ngx__WEBPACK_IMPORTED_MODULE_15__["SMS"],
...
/***/ "./src/app/componentes/chat/chat.component.html":
/*!******************************************************!*\
  !*** ./src/app/componentes/chat/chat.component.html ***!
  \******************************************************/
/*! no static exports found */
...
module.exports = "<ion-header>\n  <ion-toolbar color=\"primary\">\n\n    <ion-button slot=\"start\" fill=\"clear\" color=\"light\" (click)=\"onClickedCerrar()\">\n      <ion-icon name=\"arrow-round-back\"></ion-icon>\n    </ion-button>\n\n    <ion-avatar slot=\"start\">\n      <ion-img [src]=\"chat.img\"></ion-img>\n    </ion-avatar>\n\n    <ion-title style=\"color: white;\">\n      {{chat.name}}\n    </ion-title>\n\n  </ion-toolbar>\n</ion-header>\n\n\n\n<ion-content [scrollEvents]=\"true\">\n  <div *ngIf=\"room\">\n\n    <ion-card *ngFor=\"let mensaje of room.mensajes.slice().reverse()\">\n      <ion-item>\n        <ion-label>{{mensaje.usuario}}</ion-label>\n        <ion-datetime id=\"dynamicDisabled\" displayFormat=\"D MMM YYYY H:mm\" disabled [(ngModel)]=\"mensaje.fecha\">\n        </ion-datetime>\n      </ion-item>\n\n      <ion-card-content>\n        {{mensaje.contenido}}\n      </ion-card-content>\n    </ion-card>\n\n  </div>\n</ion-content>\n\n<ion-footer class=\"ion-padding\">\n  <ion-item>\n\n    <ion-textarea [(ngModel)]=\"msg\">\n    </ion-textarea>\n\n    <ion-button class=\"ion-button-size\" (click)=\"onClickedEnviarMensajeFirebase()\">\n      <ion-icon name=\"send\"></ion-icon>\n    </ion-button>\n\n  </ion-item>\n</ion-footer>"
...
module.exports = ".ion-button-size {\n  --display: block;\n  --height: 300px;\n  --width: 300px;\n  --border-radius: 50%; }\n\n/*# sourceMappingURL=data:application/json;base64, */"
...
var ChatComponent = /** @class */ (function () {
    function ChatComponent(chatservicio, navparams, modal) {
    ...
    ChatComponent.prototype.ngOnInit = function () {
        ...
        //INICIAMOS NUESTRA FUNCION
        this.chatservicio.getChatRoom(this.chat.id).subscribe(function (room) {
            _this.room = room;
        });
    };
    ChatComponent.prototype.onClickedCerrar = function () {
        //this.modal.ngOnDestroy();
        this.modal.dismiss();
    };
    ChatComponent.prototype.onClickedEnviarMensaje = function () {
        this.mensajes.push(this.mensaje);
    };
    ChatComponent.prototype.onClickedEnviarMensajeFirebase = function () {
        var mensaje = {
    ...
    ChatComponent = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Component"])({
            selector: 'app-chat',
            template: __webpack_require__(/*! ./chat.component.html */ "./src/app/componentes/chat/chat.component.html"),
            styles: [__webpack_require__(/*! ./chat.component.scss */ "./src/app/componentes/chat/chat.component.scss")]
        }),
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_servicios_chats_service__WEBPACK_IMPORTED_MODULE_3__["ChatsService"],
...
var NologinGuard = /** @class */ (function () {
    ...
    NologinGuard = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        ...
        tslib__WEBPACK_IMPORTED_MODULE_0__["__metadata"]("design:paramtypes", [_angular_fire_auth__WEBPACK_IMPORTED_MODULE_5__["AngularFireAuth"], _angular_router__WEBPACK_IMPORTED_MODULE_2__["Router"]])
    ], NologinGuard);
    return NologinGuard;
}());
...
/***/ "./src/app/servicios/chats.service.ts":
/*!********************************************!*\
  !*** ./src/app/servicios/chats.service.ts ***!
  \********************************************/
...
var ChatsService = /** @class */ (function () {
    function ChatsService(db) {
        this.db = db;
    }
    // VARIOS DOCUMENTOS
    ChatsService.prototype.getChatRooms = function () {
        return this.db.collection('ChatRooms').snapshotChanges().pipe(Object(rxjs_operators__WEBPACK_IMPORTED_MODULE_3__["map"])(function (rooms) {
    ...
    // VARIOS DOCUMENTOS
    ChatsService.prototype.getChatUsers = function () {
    ...
    // UN SOLO DOCUMENTO
    ChatsService.prototype.getChatUser = function (user_id) {
        return this.db.collection('Usuarios').doc(user_id).valueChanges();
    };
    // ADD CHAT
    ChatsService.prototype.Chatadd = function (name, description, img, id) {
    ...
    ChatsService.prototype.enviarMensajeFirebase = function (mensaje, chat_id) {
        this.db.collection('ChatRooms').doc(chat_id).update({
            // 'MENSAJES' ES EL AREGLO QUE SE CREA EN FIREBASE
            mensajes: firebase__WEBPACK_IMPORTED_MODULE_4__["firestore"].FieldValue.arrayUnion(mensaje),
        });
    };
    ChatsService = tslib__WEBPACK_IMPORTED_MODULE_0__["__decorate"]([
        Object(_angular_core__WEBPACK_IMPORTED_MODULE_1__["Injectable"])({
            providedIn: 'root'
        }),
...
module.exports = __webpack_require__(/*! /home/kavim/Vídeos/Chat-Ionic-Firebase/src/main.ts */"./src/main.ts");
